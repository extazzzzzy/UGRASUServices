...
<?php elseif ($_COOKIE['userpriv'] == '0'): ?>
    ...
    <hr>
    <article>
        <h2 class="h2site">Оформление стипендии Правительства РФ по приоритетным направлениям</h2>
        <div class="userinfo">
            <h3>Личные данные</h3>
        ...
        <form action="../PHP/submit.php" method="post" enctype="multipart/form-data">
            ...
            <p>Необходимую информацию можно найти <a href="https://www.ugrasu.ru/student/scholarships/#block7" target="_blank">тут</a></p>
            <br>
            <label for="file">Прикрепите все нужные документы в одном PDF-файле:</label>
            <input type="file" name="file" accept=".pdf" required>
            <br>
            <button type="submit" name="but" value="6">Отправить заявление</button>
        </form>
